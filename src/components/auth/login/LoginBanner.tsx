...
import { BadgeCheck, Handshake, Tag } from 'lucide-react';
...
const icons = [
	{
		...
		desc: 'Đăng tin rao bán đồ cũ chỉ trong vài phút, hoàn toàn miễn phí',
	},
	{
		icon: <Handshake className="text-white w-5 h-5" />,
		color: 'from-blue-400 to-blue-600',
		title: 'Giao Dịch An Toàn',
		desc: 'Kết nối trực tiếp với sinh viên, mua bán nhanh chóng và tin cậy',
	},
	{
		icon: <BadgeCheck className="text-white w-5 h-5" />,
		color: 'from-amber-400 to-amber-600',
		title: 'Nâng Cấp Premium',
		desc: 'Đăng không giới hạn và được ưu tiên hiển thị với gói VIP',
	},
];
...
export default function LoginBanner() {
	return (
		<div className="relative h-full w-full flex items-center justify-center p-6 lg:p-12 overflow-hidden bg-gradient-to-bl from-[#0a4d3c] via-[#1a5c47] to-[#2d7a5f]">
			{/* Overlay tối để nổi bật nội dung */}
			<div className="absolute inset-0 bg-black/30 backdrop-blur-[2px]" />

			{/* Nội dung chính */}
			<motion.div
				className="max-w-lg z-10 text-center lg:text-right"
			...
			>
				...
				>
					Nền tảng mua bán đồ cũ dành riêng cho sinh viên. Tiết kiệm
					chi phí, bảo vệ môi trường và kết nối cộng đồng sinh viên
					cùng nhau chia sẻ những món đồ còn tốt.
				</motion.p>
				...
				>
					<p className="text-emerald-300/60 italic text-sm">
						Đồ cũ - Giá trị mới, Sinh viên - Kết nối bền
					</p>
				</motion.div>
			</motion.div>
			...
			<div className="absolute inset-0 pointer-events-none overflow-hidden">
				{/* Orbs sáng nhẹ - tone xanh lá thân thiện */}
				<motion.div
					className="absolute -top-32 -left-32 w-[26rem] h-[26rem] rounded-full bg-gradient-to-br from-emerald-500/30 to-green-500/30 blur-[100px]"
					animate={{
						scale: [1, 1.2, 1],
						opacity: [0.3, 0.5, 0.3],
					}}
				...
				/>
				<motion.div
					className="absolute top-1/2 -right-20 w-[18rem] h-[18rem] rounded-full bg-gradient-to-br from-blue-500/20 to-teal-500/20 blur-[100px]"
					animate={{
						scale: [1, 1.3, 1],
						opacity: [0.2, 0.4, 0.2],
					}}
				...
				/>
				<motion.div
					className="absolute -bottom-20 left-1/4 w-[23rem] h-[23rem] rounded-full bg-gradient-to-br from-lime-500/20 to-emerald-500/20 blur-[100px]"
					animate={{
						scale: [1, 1.25, 1],
